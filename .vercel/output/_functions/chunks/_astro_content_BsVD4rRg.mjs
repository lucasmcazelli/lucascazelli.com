...
import { A as AstroError, L as LiveContentConfigError, n as AstroUserError, U as UnknownContentCollectionError, a as createComponent, q as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, t as renderUniqueStylesheet, v as renderScriptElement, w as createHeadAndContent, d as renderComponent } from './astro/server_BtnpNevN.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_BNUNxA78.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://lucascazelli.com", "SSR": true};
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_Cp61XMfO.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BpGG4fx4.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_D5XdFYm6.mjs');
